...
blogsRouter.post("/add/new",authentication, upload.single("files"), blogsController.addNew);
blogsRouter.put("/:id/update",authentication, upload.single("files"), blogsController.update);
